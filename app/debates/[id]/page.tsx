...
export default function DebateDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      <div className="container mx-auto px-4 py-8">
        {/* Debate Header */}
        <Card className="mb-8 bg-white dark:bg-slate-900 border border-blue-200 dark:border-blue-800 shadow-lg">
          <CardHeader>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2">
                <Button 
                  ...
                  className="flex items-center gap-1 border border-slate-300 dark:border-slate-700"
                >
                  <Share2 className="h-4 w-4" />
                  Share
                </Button>
        ...
        {/* Arguments Section */}
        <Tabs defaultValue="all" className="space-y-6">
          <TabsList className="grid w-full grid-cols-3 bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-700">
