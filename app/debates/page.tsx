      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-8 gap-6">
          <div className="relative w-full">
            ...
            <div className="relative bg-white dark:bg-slate-900 rounded-2xl p-6 border border-blue-200 dark:border-blue-800 shadow-lg">
              <div className="flex items-center gap-3 mb-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="relative group">
                ...
                <Input
                  ...
                  value={filters.search}
                  onChange={(e) => updateFilters("search", e.target.value)}
                  className="pl-10 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700"
                />
              </div>

              <Select value={filters.category || "all"} onValueChange={(value) => updateFilters("category", value)}>
                <SelectTrigger className="bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700">
                  <SelectValue placeholder="Category" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="all">All Categories</SelectItem>
          ...
          <>
            <div className="grid gap-6 mb-8">
              {debates.map((debate, index) => (
                <Card
                  key={debate.id}
                  className="bg-white dark:bg-slate-900 border border-blue-200 dark:border-blue-800 shadow-lg overflow-hidden"
                >
                  <CardHeader className="relative">
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
