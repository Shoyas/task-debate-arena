    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      <div className="container mx-auto px-4 py-8">
        ...
        <Tabs value={period} onValueChange={setPeriod} className="space-y-8">
          <TabsList className="grid w-full grid-cols-3 gap-4 mx-auto bg-slate-100  dark:bg-blue-500">
                ...
                <div className="space-y-8">
                  {scoreboard.length >= 3 && (
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                      {/* 1st Place */}
                      <Card className="text-center bg-white border border-blue-200 dark:bg-slate-900 dark:border-blue-800 shadow-lg">
